...
params.collisionBehaviour = (
    gpudrive.CollisionBehaviour.Ignore
)  # Set appropriate value
params.datasetInitOptions = (
    gpudrive.DatasetInitOptions.PadN
)  # Set appropriate value
...
for _ in range(200):
    print(
        f"steps remaining: {sim.steps_remaining_tensor().to_torch()[0][0].item()}"
    )
    sim.step()
